...
CATALOG = [
    ...
    # ------------------------------------------------------------------
    {
        ...
        "default_criteria": [
            ...
            _c("11", "Concasseur primaire", "Rendement mécanique η_mech",         "%",       93, 93, 93, 93, [85, 95],                    source="D"),
            _c("12", "Concasseur primaire", "Marge installation k_install",       "%",       30, 30, 30, 30, [20, 40],                    source="D"),
