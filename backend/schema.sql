...
ALTER TABLE IF EXISTS lims_b1 ADD COLUMN IF NOT EXISTS brwi_kwh_t NUMERIC;
ALTER TABLE IF EXISTS lims_b1 ADD COLUMN IF NOT EXISTS crushing_wi_kwh_t NUMERIC;
ALTER TABLE IF EXISTS lims_b1 ADD COLUMN IF NOT EXISTS a_x_b NUMERIC;
ALTER TABLE IF EXISTS lims_b1 ADD COLUMN IF NOT EXISTS smc_scse_kwh_t NUMERIC;
ALTER TABLE IF EXISTS lims_b1 ADD COLUMN IF NOT EXISTS bulk_density_t_m3 NUMERIC;
...
ALTER TABLE IF EXISTS lims_c2 ADD COLUMN IF NOT EXISTS p80_alim_um NUMERIC;
ALTER TABLE IF EXISTS lims_c2 ADD COLUMN IF NOT EXISTS solides_alim_pct NUMERIC;
ALTER TABLE IF EXISTS lims_c2 ADD COLUMN IF NOT EXISTS masse_alim_kg NUMERIC;
ALTER TABLE IF EXISTS lims_c2 ADD COLUMN IF NOT EXISTS au_alim_g_t NUMERIC;
ALTER TABLE IF EXISTS lims_c2 ADD COLUMN IF NOT EXISTS vitesse_knelson_rpm NUMERIC;
ALTER TABLE IF EXISTS lims_c2 ADD COLUMN IF NOT EXISTS pression_fluidisation_psi NUMERIC;
ALTER TABLE IF EXISTS lims_c2 ADD COLUMN IF NOT EXISTS duree_concentration_min NUMERIC;
ALTER TABLE IF EXISTS lims_c2 ADD COLUMN IF NOT EXISTS masse_concentre_g NUMERIC;
ALTER TABLE IF EXISTS lims_c2 ADD COLUMN IF NOT EXISTS au_concentre_g_t NUMERIC;
ALTER TABLE IF EXISTS lims_c2 ADD COLUMN IF NOT EXISTS au_tail_g_t NUMERIC;
ALTER TABLE IF EXISTS lims_c2 ADD COLUMN IF NOT EXISTS grg_rec_pct NUMERIC;
...
ALTER TABLE IF EXISTS lims_d1 ADD COLUMN IF NOT EXISTS au_leach_feed_g_t NUMERIC;
ALTER TABLE IF EXISTS lims_d1 ADD COLUMN IF NOT EXISTS p80_alim_um NUMERIC;
ALTER TABLE IF EXISTS lims_d1 ADD COLUMN IF NOT EXISTS solides_pulpe_pct NUMERIC;
ALTER TABLE IF EXISTS lims_d1 ADD COLUMN IF NOT EXISTS nacn_initiale_ppm NUMERIC;
ALTER TABLE IF EXISTS lims_d1 ADD COLUMN IF NOT EXISTS nacn_residuel_ppm NUMERIC;
ALTER TABLE IF EXISTS lims_d1 ADD COLUMN IF NOT EXISTS o2_dissous_mg_l NUMERIC;
ALTER TABLE IF EXISTS lims_d1 ADD COLUMN IF NOT EXISTS duree_h NUMERIC;
ALTER TABLE IF EXISTS lims_d1 ADD COLUMN IF NOT EXISTS carbon_dose_g_l NUMERIC;
ALTER TABLE IF EXISTS lims_d1 ADD COLUMN IF NOT EXISTS densite_solide_sg NUMERIC;
ALTER TABLE IF EXISTS lims_d1 ADD COLUMN IF NOT EXISTS leach_rec_2h_pct NUMERIC;
ALTER TABLE IF EXISTS lims_d1 ADD COLUMN IF NOT EXISTS leach_rec_4h_pct NUMERIC;
ALTER TABLE IF EXISTS lims_d1 ADD COLUMN IF NOT EXISTS leach_rec_8h_pct NUMERIC;
ALTER TABLE IF EXISTS lims_d1 ADD COLUMN IF NOT EXISTS leach_rec_12h_pct NUMERIC;
ALTER TABLE IF EXISTS lims_d1 ADD COLUMN IF NOT EXISTS leach_rec_24h_pct NUMERIC;
ALTER TABLE IF EXISTS lims_d1 ADD COLUMN IF NOT EXISTS leach_rec_48h_pct NUMERIC;
ALTER TABLE IF EXISTS lims_d1 ADD COLUMN IF NOT EXISTS preg_rob_index NUMERIC;
