...
LIMS_TABLES = {
    ...
    "e1": "lims_e1", "e2": "lims_e2", "g1": "lims_flotation",
...
LIMS_FIELDS = {
    ...
    "b1":  ["sample_id","bwi_kwh_t","brwi_kwh_t","crushing_wi_kwh_t",
             ...
             "abrasion_index_ai","ucs_mpa","bulk_density_t_m3","sag_classification"],
    ...
    "e2":  ["sample_id","filtration_rate_kg_m2_h","cake_moisture_pct",
